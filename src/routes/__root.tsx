...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfólio de edição, motion e design de Gabriel Tinti." },
      { name: "author", content: "Gabriel Tinti" },
    ...
    links: [
      ...
      { rel: "icon", href: "/media/logo-gama-favicon.png", type: "image/png" },
